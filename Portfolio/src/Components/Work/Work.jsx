  ...
  return (
    ...
    className='py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans relative'>
      {/* Section Title */}
        ...
        {/* Modal Container */}
        {selectedProject && (
          <div className='fixed inset-0 z-50 flex items-center justify-center bg-black bg-opactity-90 p-4'>
              ...
              <div className='flex flex-col'>
                ...
                <div className='lg:p-8 p-6'>
                  ...
                  <a
                    ...
                    className="block w-full bg-gray-800 hover:bg-purple-800 text-gray-400 px-6 py-3 rounded-xl lg:text-xl text-sm font-semibold text-center"
                  >
                    View Code
                  </a>
                </div>
